...
def social_code_extraction(input_text):
    ...
    Category 1: Illiteracy and low-level literacy - Z55.0
    Subcategories:
    ...
    Category 2:Unemployment, unspecified - Z56.0
    Subcategories:
      Change of job - Z56.1
      ...
      Category 2.1: Other problems related to employment - Z56.8
        Subcategories:
    ...
    Subcategories:
      ...
      Category 3.1: Occupational exposure to other air contaminants - Z57.3
        Subcategories:
    ...
    Subcategories:
      ...
      Category 4.1: Other problems related to physical environment - Z58.8
      Subcategories:
    ...
    Subcategories:
      ...
      Category 5.3: Lack of adequate food - Z59.4
      Subcategories:
      ...
      Other problems related to housing and economic circumstances - Z59.8
        Category 5.4: Housing instability, housed - Z59.81
        Subcategories:
    ...
    Category 7: Problems related to upbringing
      ...
      Category 7.1: Upbringing Away from Parents - Z62.2
      Subcategories:
      ...
      Category 7.2: Other Specified Problems Related to Upbringing - Z62.8
        Category 7.21: Personal History of Abuse in Childhood - Z62.81
      ...
      Category 7.3: Parent-Child Conflict - Z62.82
      ...
      Category 7.4: Non-Parental Relative or Guardian-Child Conflict - Z62.83
      ...
      Category 7.5: Other Specified Problems Related to Upbringing - Z62.89
    ...
    Subcategories:
      ...
      Category 8.1: Absence of Family Member - Z63.3
      Subcategories:
    ...
    Category 8.2: Other Stressful Life Events Affecting Family and Household - Z63.7
    Subcategories:
    ...
    """
    prompt = f"""
      Following is a list of possible social determinants of health factors and their corresponding codes in different nested categories and subcategories:
      {all_codes}
      ...
      Instructions:
      1.Review the input text to identify if any of the mentioned factors are present, even if not phrased exactly as specified.
      2.For any identified piece of text: check all the given nested subcategories first to find the most specific code. 
      3.If you do not find any specific subcategory for the identified text, then only mention its corresponding category.
      3.Only Return the identified piece of text as it and its corresponding factor and associated code in the following format:
      ...
      6. Do not hallucinate, display all the codes that you find.
      """  
...
output1 = process_ccda('/content/Patient-1_housing.xml') #('/content/Patient-1_housing.xml')
